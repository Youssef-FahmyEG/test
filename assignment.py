...
df = pd.read_csv(r"C:\Users\youss\Downloads\heart.csv")
...
with tab3 :
    ...
    with col2 :
        ...
        st.plotly_chart(px.bar(new_df.groupby("sex")["target"].sum().reset_index(), x = "sex", y = "target", color_discrete_sequence = ["blue"]) , use_conyainer_width = True)
